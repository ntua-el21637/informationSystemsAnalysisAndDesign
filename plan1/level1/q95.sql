WITH
  ws_wh AS (
   ...
   FROM
     cassandra.db_cassandra.web_sales ws1
   , cassandra.db_cassandra.web_sales ws2
...
, mariadb.db_infsystems.customer_address
, mariadb.db_infsystems.web_site
WHERE (CAST("d_date" AS DATE) BETWEEN CAST('1999-2-01' AS DATE) AND (CAST('1999-2-01' AS DATE) + INTERVAL  '60' DAY))
   ...
   FROM
     mariadb.db_infsystems.web_returns
   , ws_wh
